...
public class FastCash extends JFrame {
	...
	public FastCash() {
		...
		JLabel lblNewLabel = new JLabel("Enter Amount The amount");
		...
		withdraw.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Database.cashWithdraw(am, c);
				JOptionPane.showMessageDialog(null, "'"+am+"' withdrawn from the account");
			}
		});
		withdraw.setBounds(188, 78, 159, 25);
		panel_2_1.add(withdraw);
		
		cash = new JTextField();
		cash.setBounds(12, 12, 335, 42);
		panel_2_1.add(cash);
		cash.setColumns(10);
